...
# サイドバー（入力画面）
st.sidebar.header('Input Features') # ヘッダー名を指定
sepalValue = st.sidebar.slider('sepal length (cm)', min_value=0.0, max_value=10.0, step=0.1) # がく片の長さ
petalValue = st.sidebar.slider('petal length (cm)', min_value=0.0, max_value=10.0, step=0.1) # 花弁の長さ
